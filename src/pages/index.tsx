...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`A.I. Friend`}</title>

        <meta
          name="description"
          content="Experience companionship like never before with A.I. Friend. The first app designed with human emotions and empathy, providing interactive communication for individuals with autism."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1677442136019-21780ecad995?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSXxlbnwwfHx8fDE2OTQzNjA4NDB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@steve_j?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Steve Johnson`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience companionship like never before with A.I. Friend. The first app designed with human emotions and empathy, providing interactive communication for individuals with autism.`}
            </Text>
            <Box
