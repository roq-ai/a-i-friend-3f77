...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'app_administrator.count', 'app_developer.count', 'feedback.count', 'support_staff.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('app_administrator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'app_administrator',
          header: 'App Administrator',
          accessorKey: 'app_administrator',
          cell: ({ row: { original: record } }: any) => record?._count?.app_administrator,
        }
      : null,
    hasAccess('app_developer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'app_developer',
          header: 'App Developer',
          accessorKey: 'app_developer',
          cell: ({ row: { original: record } }: any) => record?._count?.app_developer,
        }
      : null,
    hasAccess('feedback', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('support_staff', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'support_staff',
          header: 'Support Staff',
          accessorKey: 'support_staff',
          cell: ({ row: { original: record } }: any) => record?._count?.support_staff,
        }
      : null,
