...
import { getAppDeveloperById } from 'apiSdk/app-developers';
import { AppDeveloperInterface } from 'interfaces/app-developer';

function AppDeveloperViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('app_developer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/app-developers/edit/${id}`} passHref legacyBehavior>
                    <Button
