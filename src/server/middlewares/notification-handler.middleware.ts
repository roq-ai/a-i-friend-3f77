...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'feedback.create': {
    roles: ['app-owner', 'app-administrator', 'app-developer', 'support-staff'],
    key: 'feedback-received',
    tenantPath: ['organization', 'feedback'],
    userPath: [],
  },
  'user.delete': {
    roles: ['app-owner', 'app-administrator'],
    key: 'staff-removed',
...
const tenantRoles: string[] = ['app-owner', 'app-administrator', 'app-developer', 'support-staff'];
